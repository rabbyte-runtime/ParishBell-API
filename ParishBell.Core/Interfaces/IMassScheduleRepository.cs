...
public interface IMassScheduleRepository
{
    ...
    Task<List<FollowedMassScheduleResult>> GetForFollowedLocationsAsync(Guid userId, string languageCode, DateOnly fromDate, DateOnly toDate, CancellationToken ct = default);
}
